...
class Mutex
{
	...
	public:
		/**
		 * @brief A class to implement the lock functionality for the Mutex
		 * class
		 *
		...
		/**
		 * @brief A class to implement the try-lock functionality for the Mutex
		 * class
		 */
		class TryLock;
	...
	private:
		...
		/**
		 * @brief Method to acquire the mutex with timeout (for use by Lock
		 * nested class)
		 */
		bool lock(double timeout_ms);

		/**
		 * @brief Method to try to acquire the mutex (for use by TryLock nested
		 * class)
		 */
		bool trylock();

		/**
		 * @brief Method to release the mutex (for use by Lock and TryLock
		 * nested class)
		 */
		void unlock();
};
...
class Mutex::Lock
{
	...
	public:
		 ...
		 * This signal will be received by all threads that are currently
		 * waiting.
		 */
		void notifyAll();
