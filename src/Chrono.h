...
class Chrono
{
	...
	public:
		 ...
		 * Whether a timer is active is determined by comparing its start time
		 * and stop time: if they are equal, the chronometer is inactive,
		 ...
		 * Note that, while a chronometer is active, the stop time is equal to
		 * the start time.
